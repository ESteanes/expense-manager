...
var _ MappedNullable = &WebhookEventResourceAttributes{}
...
type _WebhookEventResourceAttributes WebhookEventResourceAttributes
...
func (o *WebhookEventResourceAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookEventResourceAttributes := _WebhookEventResourceAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebhookEventResourceAttributes)

	if err != nil {
		return err
	}

	*o = WebhookEventResourceAttributes(varWebhookEventResourceAttributes)
