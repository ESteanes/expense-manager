...
**CardPurchasedMethod** | Pointer to **interface{}** | A field which describes whether or not the transaction was purchased using the Up Plastic Card. | [optional] 
...
### GetCardPurchasedMethod

`func (o *TransactionResourceAttributes) GetCardPurchasedMethod() interface{}`

GetCardPurchasedMethod returns the CardPurchasedMethod field if non-nil, zero value otherwise.

### GetCardPurchasedMethodOk

`func (o *TransactionResourceAttributes) GetCardPurchasedMethodOk() (*interface{}, bool)`

GetCardPurchasedMethodOk returns a tuple with the CardPurchasedMethod field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetCardPurchasedMethod

`func (o *TransactionResourceAttributes) SetCardPurchasedMethod(v interface{})`

SetCardPurchasedMethod sets CardPurchasedMethod field to given value.

### HasCardPurchasedMethod
...
### SetCardPurchasedMethodNil

`func (o *TransactionResourceAttributes) SetCardPurchasedMethodNil(b bool)`

 SetCardPurchasedMethodNil sets the value for CardPurchasedMethod to be an explicit nil

### UnsetCardPurchasedMethod
`func (o *TransactionResourceAttributes) UnsetCardPurchasedMethod()`

UnsetCardPurchasedMethod ensures that no value is present for CardPurchasedMethod, not even an explicit nil
### GetSettledAt
